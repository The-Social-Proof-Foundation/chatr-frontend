    ...
    return (
      <div>
        <div className="relative inline-grid h-9 grid-cols-[1fr_1fr] items-center text-sm font-medium">
            <div className="peer data-[state=unchecked]:bg-input/50 absolute inset-0 h-[inherit] w-auto rounded-md bg-input/50" />
    ...
    <div>
      <div className="relative inline-grid h-6 grid-cols-[1fr_1fr] items-center text-sm font-medium">
        <Switch
          ...
          className="peer data-[state=unchecked]:bg-[var(--foreground)] data-[state=checked]:bg-[var(--foreground)] absolute inset-0 h-[inherit] w-auto rounded-md [&>*]:z-10 [&>*]:h-full [&>*]:w-1/2 [&>*]:rounded-sm [&>*]:!bg-[var(--background)] [&>*]:transition-transform [&>*]:duration-300 [&>*]:ease-out [&>*]:data-[state=checked]:translate-x-full [&>*]:data-[state=checked]:rtl:-translate-x-full"
        />
