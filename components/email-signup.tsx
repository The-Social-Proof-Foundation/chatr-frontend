...
export function EmailSignup() {
  ...
  return (
    <div className="flex flex-col gap-4 w-full max-w-xl mx-auto font-plus-jakarta-sans">
      <form onSubmit={handleSubmit} className="flex flex-col gap-3">
        <div className="flex flex-col sm:flex-row gap-2">
          ...
          <Button
            type="submit"
            disabled={isLoading}
            className="bg-[var(--primary)] hover:bg-[var(--primary)]/90 font-plus-jakarta-sans text-[var(--primary-foreground)]"
          >
            {isLoading ? (
              <>
      ...
      <div className="flex justify-center items-center gap-6 mt-2">
        ...
        {/* MySo Logo */}
        <Link 
          href="https://www.mysocial.network/ecosystem/chatr"
